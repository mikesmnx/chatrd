...
const WORKER_MESSAGE_TRANSLATIONS: Record<string, string> = {
  ...
  'Choose a configured source chat': 'Выберите настроенный чат-источник.',
  'Test message is required': 'Введите тестовое сообщение.',
  'Test message cannot exceed 8,000 characters': 'Тестовое сообщение не должно превышать 8 000 символов.',
